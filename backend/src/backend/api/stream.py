...
JSON-событиями: ready, wake, partial, thinking, question, answer, listening,
error. Такой канал заметно быстрее загрузки файлов: обращение ловится на лету,
а тяжёлая модель включается только на саму реплику.
"""
