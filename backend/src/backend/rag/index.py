...
QUESTION_WORDS = frozenset(
    ["скажи", "скажите", "подскажи", "подскажите", "найди", "найти", "где", "какой", "какая", "какие", "какого", "кабинет", "кабинете", "аудитория", "номер", "телефон", "почта", "email", "адрес", "сидит", "сидят", "находится", "находятся", "работает", "работают", "человек", "сотрудник", "сотрудника", "пожалуйста", "патрис", "привет", "здравствуйте", "нужен", "нужна", "нужно", "зовут", "можно"]
)
